    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', djtools.dbfields.CharFieldPlus(default='Em Aberto', max_length=25, verbose_name='Estado do Empr\xe9stimo', choices=[('Devolvido', 'Devolvido'), ('Aguardando Termo', 'Aguardando Termo'), ('Solicitado', 'Solicitado'), ('Pendente', 'Pendente'), ('Em Aberto', 'Em Aberto'), ('Vigente', 'Vigente')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_servico', djtools.dbfields.CharFieldPlus(default='Aguardando Diagn\xf3stico', choices=[('Cacelado', 'Cancelado'), ('Recolhido', 'Recolhido'), ('Devolvido', 'Devolvido'), ('Aguardando Diagn\xf3stico', 'Aguardando Diagn\xf3stico'), ('Em Execu\xe7\xe3o', 'Em Execu\xe7\xe3o'), ('Suspenso', 'Suspenso')], max_length=25, blank=True, null=True, verbose_name='Estado')),
                ...
                ('anexo_nota_fiscal_recibo', models.FileField(upload_to=b'systi/anexoNotasFiscaisOuRecibos/', null=True, verbose_name=b'Anexar Nota Fiscal ou Recibo', blank=True)),
                ('anexo_termo', models.FileField(upload_to=b'systi/anexoTermosServico/', null=True, verbose_name=b'Anexar Termo', blank=True)),
                ...
                ('equipamentos_enviados', djtools.dbfields.ManyToManyFieldPlus(to='systi.Ativo', verbose_name='Equipamentos a serem Consertados')),
