    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', djtools.dbfields.CharFieldPlus(default=('Em Aberto',), max_length=25, verbose_name='Estado do Empr\xe9stimo', choices=[(('Em Aberto',), 'Em Aberto'), (('Pendente',), 'Pendente'), (('Vigente',), 'Vigente'), (('Devolvido',), 'Devolvido'), (('Aguardando Termo',), 'Aguardando Termo'), (('Solicitado',), 'Solicitado')])),
